...
import com.weixin.sdk.oauth2.common.token.BasicOAuthToken;
import com.weixin.sdk.oauth2.common.token.OAuthToken;
...
public class OAuthJSONAccessTokenResponse extends OAuthAccessTokenResponse {
    ...
    public String getErrorCode() {
        return getParam(OAuth.OAUTH_ERROR_CODE);
    }

    @Override
    public String getErrorMsg() {
        return getParam(OAuth.OAUTH_ERROR_MSG);
    }
