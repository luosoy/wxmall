...
import com.weixin.sdk.oauth2.client.request.OAuthClientRequest.OAuthRequestBuilder;
...
public class OAuthBearerClientRequest extends OAuthRequestBuilder  {
    ...
    public OAuthBearerClientRequest setOpenid(String openid) {
        this.parameters.put(OAuth.OAUTH_OPENID, openid);
        return this;
    }
    
    public OAuthBearerClientRequest setLang(String lang) {
        this.parameters.put(OAuth.OAUTH_LANG, lang);
        return this;
    }
