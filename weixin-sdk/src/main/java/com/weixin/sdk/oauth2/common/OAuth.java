 ...
 */
package com.weixin.sdk.oauth2.common;

import com.weixin.sdk.oauth2.common.message.types.ParameterStyle;
import com.weixin.sdk.oauth2.common.message.types.TokenType;
...
public final class OAuth {
    ...
    public static final String OAUTH_APPSECRET = "secret";
    ...
    public static final String OAUTH_LANG = "lang";
    public static final String OAUTH_ERROR_CODE = "error_code";
    public static final String OAUTH_ERROR_MSG = "error_msg";
