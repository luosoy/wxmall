...
package com.weixin.sdk.oauth2.client.request;

import java.util.HashMap;
import java.util.Map;

import com.weixin.sdk.oauth2.common.OAuth;
import com.weixin.sdk.oauth2.common.OAuthProviderType;
import com.weixin.sdk.oauth2.common.exception.OAuthSystemException;
import com.weixin.sdk.oauth2.common.message.OAuthMessage;
import com.weixin.sdk.oauth2.common.message.types.GrantType;
import com.weixin.sdk.oauth2.common.parameters.BodyURLEncodedParametersApplier;
import com.weixin.sdk.oauth2.common.parameters.OAuthParametersApplier;
import com.weixin.sdk.oauth2.common.parameters.QueryParameterApplier;
...
public class OAuthClientRequest implements OAuthMessage {
    ...
    public static class AuthenticationRequestBuilder extends OAuthRequestBuilder {
        ...
        public AuthenticationRequestBuilder setAppid(String appid) {
            this.parameters.put(OAuth.OAUTH_APPID, appid);
            return this;
        }
    ...
    public static class TokenRequestBuilder extends OAuthRequestBuilder {
        ...
        public TokenRequestBuilder setAppid(String appid) {
            this.parameters.put(OAuth.OAUTH_APPID, appid);
            return this;
        }

        public TokenRequestBuilder setAppsecret(String secret) {
            this.parameters.put(OAuth.OAUTH_APPSECRET, secret);
            return this;
        }
        
        public TokenRequestBuilder setView(String view) {
            this.parameters.put(OAuth.OAUTH_VIEW, view);
            return this;
        }
